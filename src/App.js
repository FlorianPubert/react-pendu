...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.hangmanElement = React.createRef()
    }
    ...
    reset = () => {
        ...
        this.hangmanElement.current.reset(MAX_LIFE)
    }

    isWin(matchedLetter, word) {
        // remove space
    ...
    render() {
        const {errorCount, life, matchedLetter, word} = this.state
        return (
            <div className="container">
                ...
                <div className="row justify-content-md-center mt-5">
                    <div className="col-5 text-center">
                        <Hangman ref={this.hangmanElement} errorCount={errorCount} life={life} />
                    </div>
                </div>
            </div>
        )
    ...
    replay(life, matchedLetter, word) {
